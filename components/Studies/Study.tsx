...
const Study = ({ date, title, text, image, even }: StudyItem) => {
  ...
  return (
    <div
      ref={itemRef}
      className={`border-[0.125rem] border-accent rounded-[10px] lg:rounded-[20px] overflow-hidden px-5 py-3 md:p-5 lg:p-8 xl:p-12 w-full md:w-[90%] lg:w-full transition-[opacity,transform] duration-[2000ms] delay-100 ${
        !even && "ml-auto"
      } ${
